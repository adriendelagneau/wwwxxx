...
const ProductIntro = ({
  ...
  return (
    <section
      ref={pinSectionRef}
      className="font-poppins text-primary bg-gradient-custom xl:items-center relative z-50 flex h-screen w-full justify-start p-8 lg:pt-36 text-xl sm:text-3xl xl:text-4xl 2xl:text-5xl "
    >
