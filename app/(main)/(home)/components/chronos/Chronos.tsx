...
const Chronos: React.FC = () => {
  ...
  return (
    <div className="">
      ...
      <section className="relative mx-auto flex min-h-screen w-full max-w-4xl flex-col items-center justify-center gap-12 overflow-hidden py-6 xl:max-w-6xl xl:gap-24">
        {/* YEARS BACKGROUND */}

        <div className="pointer-events-none inset-0 z-30 xl:my-4 flex items-start justify-center">
        ...
        <div className="relative z-10 mt-3 flex h-auto w-full max-w-6xl flex-col items-center justify-center gap-8 px-4 lg:flex-row lg:gap-12 lg:px-12">
          {/* ARROW NAVIGATION */}
          <div className="absolute top-1/2 z-50 flex w-full justify-between px-6 lg:px-0">
            <NavigationArrow
              direction="left"
              onClick={handlePrev}
          ...
          <div
            ref={imageRef}
            className="relative mx-auto h-64 w-72 sm:w-92 xl:h-80 xl:w-md"
          >
            <div className="bg-secondary border-secondary rotate-2 rounded-sm border p-3 pb-8 shadow-lg">
              <Image
                ...
                src={section.image.replace(
                  "/upload/",
                  "/upload/w_432,h_296,c_fill/"
                )}
