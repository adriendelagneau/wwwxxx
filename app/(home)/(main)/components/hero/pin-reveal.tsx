...
const PinnedReveal: React.FC<PinnedRevealProps> = ({ text, className }) => {
  ...
  return (
    <section
      ref={pinSectionRef}
      className="font-poppins relative z-5 capitalize flex h-screen w-full xl:items-center  justify-start pt-36 p-8  text-[24px] sm:text-4xl   2xl:text-5xl "
    >
      <div className="max-w-2xl lg:max-w-4xl xl:max-w-3xl 2xl:maw-w-4xl leading-snug text-secondary">
