...
export const CONFIG: Record<"XS" | "SM" | "MD" | "LG" | "XL" | "XXL", BreakpointConfig> = {
  ...
  XS: {
    hero: {
      intro: {
        can1: { from: { position: { x: 5, y: -0.7 }, rotation: { z: 1 }, scale: { x: 0.55, y: 0.55, z: 0.55 } }, to: { position: { x: 0, y: -0.7 }, rotation: { z: 0 } } },
      },
      final: {
        can1: { position: { x: 0, y: -0.7 }, rotation: { z: 0 }, scale: { x: 0.55, y: 0.55, z: 0.55 } },
      },
      scroll: {
  ...
  SM: {
    hero: {
      intro: {
        can1: { from: { position: { x: 5, y: -0.7 }, rotation: { z: 1 }, scale: { x: 0.65, y: 0.65, z: 0.65 } }, to: { position: { x: 0, y: -0.7 }, rotation: { z: 0 } } },
      },
      final: {
  ...
  MD: {
    hero: {
      ...
      intro: {
        can1: { from: { position: { x: 4, y: -0.65 }, rotation: { z: 1 }, scale: { x: 0.68, y: 0.68, z: 0.68 } }, to: { position: { x: 0, y: -0.65 }, rotation: { z: 0 } } },
      },
      final: {
