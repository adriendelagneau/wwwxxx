...
export default function Sidebar() {
  ...
  // Register sidebar as part of intro animation
  useEffect(() => {
    registerPart();
  }, [registerPart]);
          ...
          {items.map((item, index) => (
            <div key={item.href} className="overflow-hidden">
              ...
              >
                Breizh{" "}
                <span
                  className={`text-primary font-poppins text-4xl transition-colors duration-300 lg:text-5xl 2xl:text-6xl`}
                >
                  {item.label}
                </span>
              </MenuLink>
      ...
      <div className="overflow-hidden p-8">
        ...
        >
          ...
          <Link href="https://facebook.com/breizh-cola">
            <svg
              className="fill-primary h-8 w-8 cursor-pointer sm:h-12 sm:w-12 lg:w-14"
              viewBox="0 0 31.5 58"
            >
